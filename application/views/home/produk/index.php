<div class="container-fluid pt-5">
  ...
  <tbody>
    ...
    <tr>
      ...
      <a href="<?php echo site_url('produk/get_by_id/'.$val->idProduk);?>" class="btn btn-warning">Edit</a>
      <a href="<?php echo site_url('produk/delete/'.$val->idProduk.'/'.$val->idToko);?>" onclick="return confirm('Yakin Akan Hapus Data Ini?')" class="btn btn-danger">Hapus</a>
</div>
</td>
    </tr>
<?php $no++; } ?>
